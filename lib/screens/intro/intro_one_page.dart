...
Widget introOne(IntroController introController) => Container(
      decoration: const BoxDecoration(
        image: DecorationImage(
          image: AssetImage(AppImage.intro1),
          fit: BoxFit.cover,
        ),
      ),
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            celestialLabelReadmore(
                ...
                TextAlign.left),
            // celestialLabel(
            //     "Jenifer Kingsley", AppStyle.label20WhiteBold, TextAlign.left),
            // celestialLabel("exploring the new range of winter fashion wear",
            //     AppStyle.label18White, TextAlign.left),
            SizedBox(
            ...
            Padding(
              ...
              child: Container(
                  ...
                  child: celestialButtonLabel(() {
                    introController.goToHome();
                  }, "Shop Now", AppStyle.label24WhiteBold)),
            ),
            SizedBox(
